...
<div class="mx-auto p-2" style="width: 1220px; height: 700px; font-family: 'Inter', sans-serif;">
    ...
    onclick="openQRScanner('{{ $request->item->code }}')"
...
<div id="qr-modal" class="hidden fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
    <div class="bg-white p-6 rounded-lg w-80">
        ...
        <button class="px-4 py-2 mt-4 bg-blue-500 text-white rounded" onclick="closeQRScanner()">Close</button>
    </div>
</div>
