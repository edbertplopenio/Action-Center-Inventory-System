    ...
    <div class="w-full max-w-md">
      ...
      <form class="space-y-3 flex flex-col items-center" action="{{ route('registration.post') }}" method="POST">
        ...
        <div class="flex flex-col w-3/4">
          ...
          <input type="tel" name="contact_number" id="contact_number" required class="block w-full rounded-md border border-gray-300 px-2 py-1 text-xs text-gray-900 focus:ring-2 focus:ring-red-600">
        </div>
